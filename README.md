...
- 🤖 **游戏小助手** — 规则/玩法随问随答，提供新手指南、赚钱技巧与政策建议
...
| 可视化 | 纯面板数据 | 3D 微缩沙盘实时展示村庄全貌 |

## 技术栈

- **前端**：HTML5 + CSS3 + JavaScript (ES6+ Modules)
- **渲染**：DOM 面板式 UI + Canvas（钓鱼场景、价格走势图）+ Three.js（3D 村庄全景）
...
| 3D 全景 | 切换到「🗺️ 全景」标签页，拖拽旋转/滚轮缩放/双击重置 |
| 音量调节 | 点击顶栏 🎵 按钮，分别调节音乐/音效 |
| 游戏规则 | 点击顶栏 ❓ 按钮查看完整玩法介绍 |
| 游戏小助手 | 规则弹窗顶部点击「小村助」入口进入对话 |
...
│   │   ├── VillageDiorama.js     # 3D 村庄微缩沙盘（Three.js）
